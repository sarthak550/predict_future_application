...
export function TerminalShell({
  ...
  return (
    <div className="flex flex-col gap-4">
      {header}
      {/* The ladder is the workhorse pane — it gets the largest share so the
          full CE | strike | PE spread (plus B/S chips) fits without clipping;
          the chart flexes, the ticket stays a fixed comfortable column. */}
      <div className={ladder ? "grid grid-cols-1 gap-4 lg:grid-cols-[minmax(320px,1fr)_minmax(0,1.7fr)_360px]" : "grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_360px]"}>
