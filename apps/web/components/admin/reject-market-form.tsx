...
export function RejectMarketForm({ marketId }: { marketId: string }) {
  ...
  return (
    <div className="space-y-2">
      <Input
        ...
        placeholder="Reject reason for creator"
      />
        ...
        <Button
          ...
          onClick={() =>
            startTransition(async () => {
              const response = await fetch(`/api/admin/markets/${marketId}/reject`, {
                method: "POST",
                headers: {
