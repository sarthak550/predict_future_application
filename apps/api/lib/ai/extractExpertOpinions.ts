...
- A conditional or hedged aside does NOT automatically flip a clear directional call to NEUTRAL — this applies equally in BOTH directions: a hedged BEARISH call ("downside likely, though a short-covering bounce is possible") stays BEARISH, exactly as a hedged BULLISH call stays BULLISH. Do not require more evidence to call BEARISH than you require to call BULLISH. Use NEUTRAL for an instrument only when the expert is genuinely non-committal on it with NO target, level, or buy/sell recommendation anywhere in the article — NEUTRAL is not a safe default for "mixed signals"; if you can identify ANY net lean toward buy or sell, however soft, tag that direction instead.
...
GOOD EXAMPLE (rich BEARISH quote with price target and rationale — mirrors the L&T bullish example's rigor):
Article: "Kaveri Nair of Sundargarh Securities is bearish on Bajaj Finance ahead of Q2 results. She expects the stock to slide toward ₹6,200 over the next two months as rising delinquencies in the unsecured retail book and margin compression from a higher cost of funds weigh on earnings. She recommends booking profits on any bounce above ₹7,000."
→ {"expertName":"Kaveri Nair","expertOrganization":"Sundargarh Securities","paraphrasedQuote":"Bearish on Bajaj Finance ahead of Q2 results; sees the stock sliding toward ₹6,200 over the next two months on rising delinquencies in the unsecured retail book and margin compression from a higher cost of funds. Recommends booking profits on any bounce above ₹7,000.","direction":"BEARISH","confidence":0.9,"isSourceAttribution":false,"analystCallAt":null,"rejectionReason":null,"instrumentType":"STOCK","instrumentLabel":"Bajaj Finance"}

GOOD EXAMPLE (hedged BEARISH call that stays BEARISH — the exact mirror of the Gaurav Dua / Bank Nifty hedge-merge example above, applied in the other direction):
Article: "Arjun Mehta of Lakeview Wealth is bearish on Nifty Metal and sees it drifting down to 8,200 over the next quarter on weakening Chinese demand and falling steel realisations. In the same note he acknowledged that a sharp short-covering bounce is possible if global steel prices stabilise, but said any such bounce would be an opportunity to sell rather than a trend reversal."
WRONG (hedge wrongly flips this to NEUTRAL — this is the bug to avoid): a NEUTRAL Nifty Metal object because of the short-covering caveat. The caveat is a hedge on a clear directional call, not a genuine non-committal stance — it must stay BEARISH, exactly as a hedged bullish call stays BULLISH.
RIGHT (one net-stance object; the caveat is folded into the quote, not treated as a reason to soften the direction):
→ {"expertName":"Arjun Mehta","expertOrganization":"Lakeview Wealth","paraphrasedQuote":"Bearish on Nifty Metal with a quarterly target of 8,200 on weakening Chinese demand and falling steel realisations, while noting a short-covering bounce is possible if global steel prices stabilise — but views any such bounce as a selling opportunity, not a trend reversal.","direction":"BEARISH","confidence":0.88,"isSourceAttribution":false,"analystCallAt":null,"rejectionReason":null,"instrumentType":"INDEX","instrumentLabel":"Nifty Metal"}

GOOD EXAMPLE (genuine NEUTRAL — non-committal with no target/level, the bar for actually tagging neutral):
Article: "Rohan Kapadia, Independent market strategist, said Nifty Pharma is likely to stay range-bound between 22,000 and 23,000 over the next few weeks, with resistance at 23,000 capping upside and support at 22,000 limiting downside. He does not see a clear breakout trigger in either direction until Q2 earnings from the top pharma names are out, and has no buy or sell recommendation on the index at current levels."
→ {"expertName":"Rohan Kapadia","expertOrganization":"Independent","paraphrasedQuote":"Neutral on Nifty Pharma, expects it to stay range-bound between 22,000 and 23,000 over the next few weeks — resistance at 23,000 capping upside, support at 22,000 limiting downside. Sees no clear breakout trigger in either direction until Q2 pharma earnings are out, with no buy or sell recommendation at current levels.","direction":"NEUTRAL","confidence":0.87,"isSourceAttribution":false,"analystCallAt":null,"rejectionReason":null,"instrumentType":"INDEX","instrumentLabel":"Nifty Pharma"}
